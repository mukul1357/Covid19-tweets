...
var data = [];
var column_info = [];
var filename = "Doctor_Tweets.csv"
export default class UADoctor extends Component {
    constructor(props){
        super(props);
    ...
    async getCountUsers() {
          ...
          let url = 'http://localhost:4000/api/getTweetsfromDoctors'
          bg.filter = 'blur(2px)';
    ...
    componentDidMount() {
        column_info = ["User Name of Doctor", "Tweets"]
        this.getCountUsers();
      }
